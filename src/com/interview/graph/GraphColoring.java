...
class GraphColoring {
    ...
    private void WelshPowell(){
        ...
        sortedSet.addAll(graph.getAllVertex());
        
        Map<Long,String> assignedColor = new HashMap<>();
        Map<Long,String> finalAssignedColor = new HashMap<>();
        
        Map<String,Boolean> colorsUsed = new TreeMap<>();
...
// --Commented out by Inspection STOP (8/10/17, 5:13 PM)
    ...
    private void resetColor(Map<String,Boolean> colorsUsed){
        ...
        colors.addAll(colorsUsed.keySet());
