 ...
 */
class TournamentDay55 {

    private static int[] cutArray(int[] a) {
    ...
    private static int fndMx(int[] a, int[] b, int r) {
        ...
        int f = fndMx(a, cutArray(b), r);
        int s = fndMx(cutArray(a), cutArray(b), r + Math.abs(a[0] - b[0]));
        return Math.min(f, s);
    }
...
// --Commented out by Inspection STOP (8/10/17, 5:13 PM)
    ...
    private static String insertDashes() {
        String[] words = "aba caba".split(" ");
...
// --Commented out by Inspection STOP (8/10/17, 5:13 PM)
    ...
    public static void main(String[] args) {
        ...
        System.out.println(insertDashes());
    }
