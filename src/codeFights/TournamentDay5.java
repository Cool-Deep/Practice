...
// --Commented out by Inspection STOP (8/10/17, 5:13 PM)
    ...
    private static boolean checkSameElementExistence(int[] arr1, int[] arr2) {
...
// --Commented out by Inspection START (8/10/17, 5:13 PM):
//    private static int chessBoardSquaresUnderQueenAttack2(int a, int b) {
//        if (a == 1 || b == 1) {
//            if (a == 1 && b == 1)
//                return 0;
//            else if (a > 1)
