...
// --Commented out by Inspection STOP (8/10/17, 5:13 PM)
    ...
    private static int[] sumOfBigNumbers(int[] a, int[] b) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(sumOfBigNumbers(new int[]{1, 2, 3, 4, 5}, new int[]{9, 8, 7, 6, 5})));
    }
