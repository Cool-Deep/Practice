...
// --Commented out by Inspection STOP (8/10/17, 5:13 PM)
    ...
    public static void main(String[] args) {
        ...
        System.out.println(closestLocation(new int[][]{{-2, 0}, {1, 2}, {2, 1, 2, 4}, {-3, -1, 4, -1}},
