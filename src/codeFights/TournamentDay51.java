...
//        return 'A' <= inputString.charAt(0) && 'Z' >= inputString.charAt(0) && inputString.charAt(inputString.length() - 1) == '.';
//
//    }
// --Commented out by Inspection STOP (8/10/17, 5:13 PM)
...
////            }
////
////            void split(int[] sequence, int right) {
////
////                int middle = (0 + right) / 2;
////
////                if (0 + 1 == right) {
////                    return;
////                }
////                Arrays.sort(sequence);
////                merge(sequence, 0, middle, right);
// --Commented out by Inspection STOP (8/10/17, 5:13 PM)
//            }
//        }
// --Commented out by Inspection STOP (8/10/17, 5:13 PM)
        ...
        h.split(sequence, sequence.length);
...
// --Commented out by Inspection STOP (8/10/17, 5:13 PM)
    ...
    private static String strangeCode() {
        char prevSymb = '-';
        String res = "";
    ...
    public static void main(String[] args) {
        ...
        System.out.println(strangeCode());
    }
