...
// --Commented out by Inspection STOP (8/10/17, 5:13 PM)
    ...
    private static int[][] blackAndWhiteBoard(String[] queries) {
        ...
        for (String query : queries) {
            cmd = query.substring(0, 1);
            x = Integer.parseInt(query.substring(2, 3));
            y = Integer.parseInt(query.substring(4, 5));
            switch (cmd) {
                case "x":
                    board[x][y] = 1;
                    break;
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.deepToString(blackAndWhiteBoard(new String[]{"> 1 0",
                "v 0 1",
                "< 1 2",
                "^ 2 1",
                "x 1 1",
